    ...
    <table class ="table-sm reportTable">
        <thead>
            <tr>
                ...
                <th class="text-center" rowspan="2">{{ TranslationHelper::translate(ucwords('slip/elevator groove')) }}</th>
        ...
        <tbody>
            <tr>
                ...
                <td><x-default.input type="text" class="w-auto" name="desc[0][slip_groove]" id="slip_groove0" placeholder="----------" /></td>
            ...
            <tr>
                ...
                <td><x-default.input type="text" class="w-auto" name="desc[1][slip_groove]" id="slip_groove1" placeholder="----------" /></td>
            ...
            <tr>
                ...
                <td><x-default.input type="text" class="w-auto" name="desc[2][slip_groove]" id="slip_groove2" placeholder="----------" /></td>
            ...
            <tr>
                ...
                <td><x-default.input type="text" class="w-auto" name="desc[3][slip_groove]" id="slip_groove3" placeholder="----------" /></td>
            ...
            <tr>
                ...
                <td><x-default.input type="text" class="w-auto" name="desc[4][slip_groove]" id="slip_groove4" placeholder="----------" /></td>
            ...
            <tr>
                ...
                <td><x-default.input type="text" class="w-auto" name="desc[5][slip_groove]" id="slip_groove5" placeholder="----------" /></td>
            ...
            <tr>
                ...
                <td><x-default.input type="text" class="w-auto" name="desc[6][slip_groove]" id="slip_groove6" placeholder="----------" /></td>
            ...
            <tr>
                ...
                <td><x-default.input type="text" class="w-auto" name="desc[7][slip_groove]" id="slip_groove7" placeholder="----------" /></td>
            ...
            <tr>
                ...
                <td><x-default.input type="text" class="w-auto" name="desc[8][slip_groove]" id="slip_groove8" placeholder="----------" /></td>
            ...
            <tr>
                ...
                <td><x-default.input type="text" class="w-auto" name="desc[9][slip_groove]" id="slip_groove9" placeholder="----------" /></td>

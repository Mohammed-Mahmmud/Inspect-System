        ...
        <thead>
            <tr>
                ...
                <th class="text-center" colspan="12">
                    ...
                    <x-default.input class="hidden" type="text" name="box_conn" value="{{ $tubs->box_conn ?? '' }}"
                        placeholder="--------------------------------------" />
                </th>
                <th class="text-center" rowspan="2">{{ TranslationHelper::translate(ucwords('upset area mpi')) }}
                </th>
        ...
        <tbody>
            @for ($i = 0; $i < $count; $i++)
                <tr>
                    ...
                    {{-- {{ dd(isset(getDeCode($tubs->getDesc[$i]->description)['box_length'])) }} --}}
                    <td><x-default.input
                    ...
                    <td><x-default.input
                            value="{{ isset($tubs->getDesc[$i]) ? getDeCode($tubs->getDesc[$i]->description)['upset_mpi'] : '' }}"
                            type="text" class="w-auto" name="desc[{{ $i }}][upset_mpi]"
                            id="upset_mpi{{ $i }}" placeholder="----------" /></td>
                    <td><x-default.input
                            value="{{ isset($tubs->getDesc[$i]) ? getDeCode($tubs->getDesc[$i]->description)['banding_pin'] : '' }}"
                            type="text" class="w-auto" name="desc[{{ $i }}][banding_pin]"
                            id="banding_pin{{ $i }}" placeholder="----------" /></td>
                    <td><x-default.input
                            value="{{ isset($tubs->getDesc[$i]) ? getDeCode($tubs->getDesc[$i]->description)['banding_middle'] : '' }}"
                            type="text" class="w-auto" name="desc[{{ $i }}][banding_middle]"
                            id="banding_middle{{ $i }}" placeholder="----------" /></td>
                    <td><x-default.input
                            value="{{ isset($tubs->getDesc[$i]) ? getDeCode($tubs->getDesc[$i]->description)['banding_box'] : '' }}"
                            type="text" class="w-auto" name="desc[{{ $i }}][banding_box]"
                            id="banding_box{{ $i }}" placeholder="----------" /></td>
                    <td><x-default.input
                    ...
                    <td><x-default.input
                            value="{{ isset($tubs->getDesc[$i]) ? getDeCode($tubs->getDesc[$i]->description)['bent'] : '' }}"
                            type="text" class="w-auto" name="desc[{{ $i }}][bent]"
                            id="bent{{ $i }}" placeholder="----------" /></td>
                </tr>
            @endfor
        </tbody>
    </table>

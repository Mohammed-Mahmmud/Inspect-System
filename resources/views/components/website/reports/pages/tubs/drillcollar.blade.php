    ...
    <table class ="table-sm reportTable">
        <thead>
            ...
            <tr>
                ...
                <th class="center">{{ TranslationHelper::translate(ucwords('neck length max')) }}</th>
                ...
                <th class="center">{{ TranslationHelper::translate(ucwords('bevel dia max')) }}</th>
                <th class="center">{{ TranslationHelper::translate(ucwords('seal width min')) }}</th>
                <th class="center">{{ TranslationHelper::translate(ucwords('shldr width min')) }}</th>
        ...
        <tbody>
            @for ($i = 0; $i < 10; $i++)
                <tr>
                    ...
                    <td>{{ isset($tubs->getDesc[$i]) ? getDeCode($tubs->getDesc[$i]->description)['slip_groove'] : '' }}
                    </td>

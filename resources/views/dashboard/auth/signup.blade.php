...
@endsection
@section('content') 
<section class="auth-page-wrapper py-5 position-relative d-flex align-items-center justify-content-center min-vh-100" style="background-image: url('{{ asset('dashboard/images/background/login.jpg') }}'); background-size: cover; background-position: center;">
    <div class="container">
                            ...
                            <div class="card mb-0 border-0 shadow-none mb-0" style="backdrop-filter: blur(10px);">
                                <div class="card-body p-sm-5 m-lg-4">
                                    <div class="text-center mt-2">
                                        <img src="{{ asset('dashboard/images/background/stc_logo.png') }}" alt="Custom Image" class="rounded mb-3" style="width: 400px; height: 200px;">
                                        <h5 class="fs-3xl">Create your Admin account</h5>
                                        <p class="text-muted">Get your Inspection Adminstration account now</p>
                                    </div>
                                    <div class="p-2 mt-5">
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="mb-4">
                                                <p class="mb-0 fs-xs text-muted fst-italic">By registering you agree to the STC System <a href="pages-term-conditions.html" class="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</a></p>
                                            </div>

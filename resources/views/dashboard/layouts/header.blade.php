            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        @if(App::getLocale()== "ar")
                        <img id="header-lang-imgs" src="{{asset('dashboard')}}/assets/images/flags/ae.svg" alt="{{ App::getLocale() }} Header Page" height="20" class="rounded">
                        @elseif (App::getLocale()== "en")
                        <img id="header-lang-imgs" src="{{asset('dashboard')}}/assets/images/flags/us.svg" alt="{{ App::getLocale() }} Header Page" height="20" class="rounded">
                        @else
                        <img id="header-lang-imgs" src="{{asset('dashboard')}}/assets/images/flags/us.svg" alt="{{ App::getLocale() }} Header Page" height="20" class="rounded">
                        @endif
                    </button>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                            ...
                            <img id="header-lang-imgs" src="{{asset('dashboard')}}/assets/images/flags/us.svg" alt="{{ App::getLocale() }} Sub Header Page" height="20" class="rounded">
                            @elseif($properties['native'] == "العربية")
                            <i class="flag-icon flag-icon-eg"></i>
                            <img id="header-lang-imgs" src="{{asset('dashboard')}}/assets/images/flags/ae.svg" alt="{{ App::getLocale() }} Sub Header Page" height="20" class="rounded">
                            @endif
                            {{ $properties['native'] }}
                        </a>
                        @endforeach

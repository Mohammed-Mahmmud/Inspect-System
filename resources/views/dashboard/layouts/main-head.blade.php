...
{{-- toster css links --}}
<link type="text/css" rel="stylesheet" href="{{ asset('dashboard/assets/css/extensions/fontawesome-5.15.3/css/all.min.css') }}">
...
<link type="text/css" rel="preconnect" href="{{ asset('dashboard/assets/css/extensions/font.css') }}">

        ...
        <div class="page-content">
            <div class="container-fluid">
                <x-dashboard.layouts.breadcrumb title1="{{ trans('Dashboard/admins.admins') }}"
                    title2="{{ trans('Dashboard/admins.admins') }}" route="{{ route('admins.index') }}"
                ...
                <div class="row">
                                    ...
                                    <div class="row g-4 mb-3">
                                        <div class="col-sm-auto">
                                            <div>
                                                ...
                                                <a class="btn btn-success add-btn" href="{{ route('admins.create') }}"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#showModal">{{ trans('Dashboard/admins.addAdmin') }}</a>
                                                ...
                                                <thead class="table-dark">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="customer_name">
                                                            {{ trans('Dashboard/admins.name') }}</th>
                                                        <th class="sort" data-sort="customer_name">
                                                            {{ trans('Dashboard/admins.full_name') }}</th>
                                                        <th class="sort" data-sort="customer_name">
                                                            {{ TranslationHelper::translate(ucfirst('status')) }}</th>
                                                        <th class="sort" data-sort="email">
                                                            {{ trans('Dashboard/admins.email') }}</th>
                                                        <th class="sort" data-sort="date">
                                                            {{ trans('Dashboard/admins.joinDate') }}</th>
                                                        <th class="sort" data-sort="action">
                                                            {{ trans('Dashboard/admins.action') }}</th>
                                                    </tr>
                                                </thead>
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-footer">
                                                                                        <div
                                                                                            ...
                                                                                            <button type="button"
                                                                                                class="btn btn-info"
                                                                                                data-bs-dismiss="modal">{{ trans('Dashboard/admins.close') }}</button>

                                                                                            <button type="submit"
                                                                                                class="btn btn-danger"
                                                                                                id="add-btn">{{ trans('Dashboard/admins.delete') }}</button>
                                                                    </form>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header bg-light p-3">
                                        <h5 class="modal-title" id="exampleModalLabel2">
                                            {{ trans('Dashboard/admins.edit') . ' ' . $item->name }}</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <label for="name"
                                                            class="form-label">{{ trans('Dashboard/admins.name') }}</label>
                                                    ...
                                                    <div class="col-6">
                                                        <label for = "full_name"
                                                            class="form-label">{{ trans('Dashboard/admins.full_name') }}</label>
                                        ...
                                        <div class="modal-footer">
                                            <div class="hstack gap-2 justify-content-end">
                                                ...
                                                <button type="submit" class="btn btn-info"
                                                    id="add-btn">{{ trans('Dashboard/admins.update_admin') }}</button>
                                    </form>
                                    <!-- <button type="button" class="btn btn-success" id="edit-btn">Update</button> -->
                                </div>
                            </div>
                    ...
                    <div class="noresult" style="display: none">
                        <div class="text-center">
                            ...
                            <p class="text-muted mb-0">We've searched more than 150+ Orders We did not find any orders for
                                you search.</p>
                        </div>
                    </div>
                </div>
    ...
    <form class="tablelist-form" action="{{ route('admins.store') }}" method="POST">
        ...
        <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3">
                        <h5 class="modal-title" id="exampleModalLabel">{{ trans('Dashboard/admins.create_new_Admin') }}
                        </h5>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control"
                                            placeholder="{{ trans('Dashboard/admins.name') }}" required>
                                    </div>
                                    <div class="col-6">
                                        <label for="full_name"
                                            class="form-label">{{ trans('Dashboard/admins.full_name') }}</label>
                                        <input type="text" id="full_name" name="full_name" class="form-control"
                                            placeholder="{{ trans('Dashboard/admins.full_name') }}" required>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="password" id="customername-pass" name="password"
                            ...
                            <div class="modal-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-success"
                                        id="add-btn">{{ trans('Dashboard/admins.add') }}</button>
                                </div>
                            </div>
                    </form>
                </div>

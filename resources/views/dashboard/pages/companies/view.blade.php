        ...
        <div class="page-content">
            <div class="container-fluid">
                <x-dashboard.layouts.breadcrumb title1="{{ trans('Dashboard/company.companies') }}"
                                        title2="{{ trans('Dashboard/company.companies') }}"
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">{{ trans('Dashboard/company.addcompanies') }}</h4>
                            </div><!-- end card header -->
                            <div class="card-body">
                                <div id="customerList">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sort"
                                                    data-sort="customer_name">{{ trans('Dashboard/company.name') }}</th>
                                                {{-- <th class="sort" data-sort="customer_full_name">{{ trans('Dashboard/company.fullname') }}</th> --}}
                                                <th class="sort"
                                                    data-sort="customer_email">{{ trans('Dashboard/company.email') }}</th>
                                                <th class="sort"
                                                    data-sort="customer_password">{{ trans('Dashboard/company.password') }}</th>
                                                {{-- <th class="sort" data-sort="action">{{ trans('Dashboard/company.location') }}</th> --}}
                                                <th class="sort"
                                                    data-sort="action">{{ trans('Dashboard/company.action') }}</th>
                                            </tr>
                                            </thead>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLongTitle">{{ trans('Dashboard/company.remove') }} {{ $item->name}}</h5>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header bg-light p-3">
                                        <h5 class="modal-title"
                                            id="exampleModalLabel2">{{ trans('Dashboard/company.edit').' '.$item->name }}</h5>
        ...
        <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3">
                        <h5 class="modal-title"
                            id="exampleModalLabel">{{ trans('Dashboard/company.create_new_company') }}</h5>

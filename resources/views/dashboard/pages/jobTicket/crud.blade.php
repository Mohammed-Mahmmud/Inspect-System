        ...
        <div class="page-content">
            <div class="container-fluid">
                <x-dashboard.layouts.breadcrumb title1="{{ trans('Dashboard/jobTicket.jobTicket') }}"
                    title2="{{ trans('Dashboard/report_type.report_types') }}" route="{{ route('jobTicket.index') }}"
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="hstack gap-2 justify-content-end">
                                                            <a type="button" style="color: black; font-weight:bold;"
                                                                ...
                                                                href="{{ route('jobTicket.index') }}">{{ trans('Dashboard/jobTicket.close') }}</a>
                                                            <button style="color: black; font-weight:bold;" type="submit"
                                                                class="btn btn-success"
                                                                id="add-btn">{{ trans('Dashboard/jobTicket.save') }}</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- end card-body -->

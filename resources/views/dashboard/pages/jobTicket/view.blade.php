        ...
        <div class="page-content">
            <div class="container-fluid">
                <x-dashboard.layouts.breadcrumb title1="{{ trans('Dashboard/jobTicket.jobTicket') }}"
                                        title2="{{trans('Dashboard/jobTicket.jobTicket') }}"
                                        ...
                                        <div class="col-sm-auto">
                                            <div>
                                                <a class="btn btn-success add-btn"
                                                   href="{{ route('jobTicket.create') }}">{{
                                                trans('Dashboard/jobTicket.addjobTicket') }}</a>
                                                {{--  <button name="delete_all" id="delete_all" class="btn btn-subtle-danger"  --}}
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <th class="" data-sort="">{{ trans('Dashboard/jobTicket.rig') }}</th>
                                                <th class="" data-sort="">{{
                                                    trans('Dashboard/jobTicket.ispr') }}</th>
                                                </th>
                                                <th class="" data-sort="">{{ trans('Dashboard/jobTicket.date') }}</th>
                                                <th class=""
                                                    data-sort="">{{ trans('Dashboard/jobTicket.ref_num') }}</th>
                                                <th class="" data-sort="">{{ trans('Dashboard/jobTicket.well_name') }}
                                                <th class="" data-sort="">{{ trans('Dashboard/jobTicket.user') }}</th>
                                                </th>

                                                <th class="" data-sort="action">{{ trans('Dashboard/jobTicket.action')
                                                    }}</th>
                                            </tr>
                                            </thead>
                                            ...
                                            @foreach($jobTickets as $item)
                                                <tr>
                                                    ...
                                                    <td class="id">{{ $i++}}</td>
                                                    <td class="customer_name">{{ $item->getOrders->companies->name}}</td>
                                                    <td class="customer_full_name">{{ $item->getOrders->rigs->name}}</td>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <div
                                                                                    ...
                                                                                    <button type="button"
                                                                                            class="btn btn-info"
                                                                                            data-bs-dismiss="modal">{{
                                                                                    trans('Dashboard/jobTicket.close')
                                                                                    }}</button>

                                                                                    <button type="submit"
                                                                                            class="btn btn-danger"
                                                                                            id="add-btn">{{
                                                                                    trans('Dashboard/jobTicket.delete_jobTicket')
                                                                                    }}</button>
                                                    </div>
                                                        </div>
                                                    </div>

                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0">{{ trans('Dashboard/Lifting/examination.' . $type . $examType) }}</h4>
                            </div><!-- end card header -->
                                                ...
                                                <div class="row">
                                                    @if($type =="Edit")
                                                        <x-form.input_label class="col-6"
                                                                            ...
                                                                            label="Report Number :" type="text"
                                                                            name="report_number" id="report_number"
                                                                            readonly/>
                                                        <x-form.dropdown class="col-6"
                                                                         label="{{ trans('Dashboard/orders.order') }}"
                                                                         name="order_id" id="order_id"
                                                                         disabledOption="Choose Order" :data="$orders"
                                                    ...
                                                    <x-form.input_label class="col-4"
                                                                        ...
                                                                        label="Thorugh Examination Date :" type="date"
                                                                        name="exam_date" id="exam_date"/>
                                                    <x-form.input_label class="col-4"
                                                                        placeholder="Enter Identified Number"
                                                                        value="{{ $examination->identified_number ?? '' }}"
                                                                        label="Identified Number :" type="text"
                                                                        name="identified_number"
                                                                        id="identified_number"/>
                                                    <x-form.input_label class="col-4" placeholder="Enter QTY"
                                                                        value="{{ $examination->qty ?? '' }}"
                                                                        label="QTY :" type="text" name="qty" id="qty"/>
                                                    @include("dashboard.pages.lifting.examination.description.$examType")
                                                    <x-form.input_label class="col-6"
                                                                        value="{{ $examination->manufature_date ?? '' }}"
                                                                        placeholder="Enter Manufature Date"
                                                                        label="Manufature Date :" type="date"
                                                                        name="manufature_date" id="manufature_date"/>
                                                    <x-form.input_label class="col-6"
                                                                        value="{{ $examination->last_exam_date ?? '' }}"
                                                                        placeholder="Enter Last_Exam Date"
                                                                        label="Last Exam Date :" type="date"
                                                                        name="last_exam_date" id="last_exam_date"/>

                                                    <x-form.input_label class="col-4"
                                                                        value="{{ $examination->original_cert_number ?? '' }}"
                                                                        placeholder="Enter Original Certificate No "
                                                                        label="Original Certificate No :" type="text"
                                                                        name="original_cert_number"
                                                                        id="original_cert_number"/>
                                                    <x-form.input_label class="col-4"
                                                    ...
                                                    <div class="accordion" id="default-accordion-example">
                                                            ...
                                                            <div id="collapseFive" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body row" style="color:black;">
                                                                    ...
                                                                    <x-form.radio-btn class="col-6" value="0"
                                                                                      ...
                                                                                      label=":Check Accourding to No"
                                                                                      name="danger" id="danger1"/>
                                                                    <x-form.radio-btn class="col-6" value="1"
                                                                                      val="{{  $examination->danger ?? ''}}"
                                                                                      label=":Check Accourding to YES"
                                                                                      name="danger" id="danger2"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="accordion-body row" style="color:black">
                                                                    <div class="col-6">
                                                                        ...
                                                                        <select name="carried_exam[]" multiple
                                                                            ...
                                                                            <option
                                                                                    value="visual_inspection" {{ isset($examination->carried_exam )&& in_array('visual_inspection', $examination->getDeCode($examination->carried_exam)) ? 'selected' : "" }}>
                                                                                Visual Inspection
                                                                            </option>
                                                                            <option
                                                                                    value="function_test" {{ isset($examination->carried_exam )&& in_array('function_test', $examination->getDeCode($examination->carried_exam)) ? 'selected' : "" }}>
                                                                                Function Test
                                                                            </option>
                                                                            <option
                                                                                    value="load_test" {{ isset($examination->carried_exam )&& in_array('load_test', $examination->getDeCode($examination->carried_exam)) ? 'selected' : "" }}>
                                                                                Load Test
                                                                            </option>
                                                                            <option
                                                                                    value="mpi" {{ isset($examination->carried_exam )&& in_array('mpi', $examination->getDeCode($examination->carried_exam)) ? 'selected' : "" }}>
                                                                                MPI
                                                                            </option>
                                                                        </select>
                                                                    </div>
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="collapseNine" class="accordion-collapse collapse"
                                                                 ...
                                                                 data-bs-parent="#default-accordion-example">
                                                                <div class="accordion-body row" style="color:black;">
                                                                    {{-- <x-form.switches class="col-12" value="{{ $examination->safe_equipment ?? '' }}" style="font-size: 1em;" label=": Choose According to Yes" name="safe_equipment" id="safe_equipment" /> --}}
                                                                    <x-form.radio-btn class="col-6" value="0"
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <div class="row">
                                                            @if($examType == "thorough")
                                                                <div class="col-8">
                                                                    @if($type =="Edit")
                                                                        @include("dashboard.pages.lifting.examination.modal.checklist" ,['examination'=>$examination])
                                                                    @else
                                                ...
                                                <div class="modal-footer">
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a type="button" style="color: black; font-weight:bold;"
                                                           ...
                                                           href="{{ route('examination.reports.index',$examType) }}">{{ trans('Dashboard/Lifting/examination.close') }}</a>

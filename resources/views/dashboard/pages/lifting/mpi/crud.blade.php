                            ...
                            <div class="card-body">
                                <div id="customerList">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="tablelist-form" action="{{ $action }}" method="POST" id="my-form"
                                            ...
                                            <div class="row">
                                                ...
                                                <x-form.input_label class="col-12"
                                                                    ...
                                                                    label="description :"
                                                                    value="{{ $mpi->description ?? '' }}" type="text"
                                                                    name="description" id="description"/>
                                                <x-form.input_label class="col-6" placeholder="Enter serial Number"
                                                                    value="{{ $mpi->serial ?? '' }}"
                                                                    label="serial Number:" type="text" name="serial"
                                                                    id="serial"/>

                                                <x-form.input_label class="col-6"
                                                                    placeholder="Enter Report Purchase Order No"
                                                                    label="Purchase Order"
                                                                    value="{{ $mpi->purchase_order_no ?? '' }}"
                                                                    type="text" name="purchase_order_no"

                            ...
                            <div class="page-title-jobTicketht">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('mud-jar.reports.index', $examType) }}">{{ trans('Dashboard/Tublar/mudjar.mudjar') }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">
                                        {{ trans('Dashboard/Tublar/mudjar.' . $type . $examType) }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <form class="tablelist-form" action="{{ $action }}" method="POST"
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-xxl-6">
                                        <h5 class="mb-3">
                                            {{ trans('Dashboard/Tublar/mudjar.' . $type . $examType . 'Details') }}
                                        </h5>
                                        <div class="card">
                                                ...
                                                <ul class="nav nav-pills custom-hover-nav-tabs">
                                                    <li class="nav-item">
                                                        <a href="#custom-hover-customere" data-bs-toggle="tab"
                                                            ...
                                                            <h5 class="nav-titl nav-tab-position m-0">
                                                                {{ trans('Dashboard/Tublar/mudjar.header') }}</h5>
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#custom-hover-reviews" data-bs-toggle="tab"
                                                            ...
                                                            <h5 class="nav-titl nav-tab-position m-0">
                                                                {{ trans('Dashboard/Tublar/mudjar.description') }}</h5>
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                                ...
                                                <div class="tab-content text-muted">
                                                    <div class="tab-pane show active" id="custom-hover-customere">
                                                        <h6 style="text-align:center">
                                                            {{ trans('Dashboard/Tublar/mudjar.' . $examType . 'Content') }}
                                                        </h6>
                                                        <div class="">
                                                    ...
                                                    <div class="tab-pane" id="custom-hover-reviews">
                                                        <h6 style="text-align:center">
                                                            {{ trans('Dashboard/Tublar/mudjar.' . $examType . 'TableDesc') }}
                                                        </h6>
                                                        <div width='100%'>
                                ...
                                <div class="modal-footer">
                                    <div class="hstack gap-2 justify-content-end">
                                        <a type="button" style="color: black; font-weight:bold;" class="btn btn-danger"
                                            href="{{ route('mud-jar.reports.index', ['type' => $examType]) }}">{{ trans('Dashboard/Tublar/mudjar.close') }}</a>
                                        <button style="color: black; font-weight:bold;" type="submit"
                                            class="btn btn-success"
                                            id="add-btn">{{ trans('Dashboard/Tublar/mudjar.save') }}</button>
                                    </div>
                                </div>
                        </form>

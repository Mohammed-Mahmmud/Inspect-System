                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a class="btn btn-success add-btn" href="{{ route('mud-jar.reports.create',['type'=>$type]) }}">{{
                                                trans('Dashboard/Tublar/mudjar.add'.$type) }}</a>
                            ...
                            <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <th class="" data-sort="">{{trans('Dashboard/tublar/mudjar.report_number') }}</th>
                                            <th class="" data-sort="">{{ trans('Dashboard/Tublar/mudjar.report_date') }}</th>
                                            <th class="" data-sort="">{{ trans('Dashboard/Tublar/mudjar.user') }}</th>
                                            {{-- <th class="" data-sort="">{{ trans('Dashboard/Tublar/mudjar.next_date') }}</th> --}}
                                            @if($type == 'thorough')
                                            <th class="" data-sort="">{{ trans('Dashboard/Tublar/mudjar.thorough_type') }}</th>
                                            @endif
                                            <th class="" data-sort="action">{{trans('Dashboard/tublar/mudjar.acceptance') }}</th>
                                            <th class="" data-sort="action">{{ trans('Dashboard/Tublar/mudjar.action')}}</th>
                                        </tr>
                                    </thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown position-static">
                                                    ...
                                                    <!-- Modal -->
                                                    <form action="{{ route('mud-jar.reports.destroy',$item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <div class="hstack gap-2 justify-content-end">
                                                                            <button type="button" class="btn btn-info" data-bs-dismiss="modal">{{
                                                                                    trans('Dashboard/Tublar/mudjar.close')
                                                                                    }}</button>

                        ...
                        <div class="page-title-summaryht">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">{{
                                        trans('Dashboard/Tublar/summary.summary') }}</a></li>
                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a class="btn btn-success add-btn" href="{{ route('tools-summary.create',['type'=>$type]) }}">{{
                                                trans('Dashboard/Tublar/summary.add_'.$type) }}</a>
                                ...
                                <table class="table align-middle mb-0">
                                    <thead class="table-dark">
                                        <tr>
                                            ...
                                            <th class="" data-sort="">{{trans('Dashboard/Tublar/summary.report_number') }}</th>
                                            <th class="" data-sort="">{{ trans('Dashboard/Tublar/summary.report_date') }}</th>
                                            <th class="" data-sort="">{{ trans('Dashboard/Tublar/summary.fin_date') }}</th>
                                            <th class="" data-sort="">{{ trans('Dashboard/Tublar/summary.user') }}</th>
                                            <th class="" data-sort="action">{{ trans('Dashboard/Tublar/summary.action')}}</th>
                                        </tr>
                                    </thead>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <!-- Modal -->
                                                    <form action="{{ route('tools-summary.destroy',$item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <div class="hstack gap-2 justify-content-end">
                                                                            <button type="button" class="btn btn-info" data-bs-dismiss="modal">{{
                                                                                    trans('Dashboard/Tublar/summary.close')
                                                                                    }}</button>

...
<div class="offcanvas offcanvas-top" tabindex="-1" id="searchTopModal" aria-labelledby="searchTopModalLabel">
    ...
    <div class="offcanvas-body">
        <form class="tablelist-form" action="{{ route('tools.reports.filter') }}" method="POST"
            enctype="multipart/form-data" id="searchForm">
            @csrf
            <div class="row align-items-center">
                <div class="col-sm col-4">
                    <x-form.dropdown class="col-12" label="Choose JobTicket Number" name="order_id" id="order_id"
                        disabledOption="Choose Order" :data="$orders" />
                </div>
                <div class=" col-sm col-6">
                    <label for="exam_date"><b>Start Report Date</b></label>
                    <input type="date" name="exam_date" id="exam_date" class="col-4 form-control"
                        placeholder="Enter Exam Date ">
                </div>
                <div class=" col-sm col-6">
                    <label for="fin_date"><b>Finish Report Date</b></label>
                    <input type="date" name="fin_date" id="fin_date" class="col-4 form-control"
                        placeholder="Enter Exam Date ">
                </div>

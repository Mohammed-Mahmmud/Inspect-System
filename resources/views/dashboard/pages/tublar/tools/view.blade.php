                        ...
                        <div class="page-title-toolsht">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">{{
                                        trans('Dashboard/Tublar/tools.tools') }}</a></li>
                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a class="btn btn-success add-btn" href="{{ route('tools.reports.create',['type'=>$type]) }}">{{
                                                trans('Dashboard/Tublar/tools.add'.$type) }}</a>
                            ...
                            <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <th class="" data-sort="">{{trans('Dashboard/Tublar/tools.report_number') }}</th>
                                            <th class="" data-sort="">{{ trans('Dashboard/Tublar/tools.report_date') }}</th>
                                            <th class="" data-sort="">{{ trans('Dashboard/Tublar/tools.fin_date') }}</th>
                                            <th class="" data-sort="">{{ trans('Dashboard/Tublar/tools.user') }}</th>
                                            @if($type == 'thorough')
                                            <th class="" data-sort="">{{ trans('Dashboard/Tublar/tools.thorough_type') }}</th>
                                            @endif
                                            <th class="" data-sort="action">{{trans('Dashboard/Tublar/tools.acceptance') }}</th>
                                            <th class="" data-sort="action">{{ trans('Dashboard/Tublar/tools.action')}}</th>
                                        </tr>
                                    </thead>
...
{{--                                                    </div>--}}
                                                    <!-- Modal -->
                                                    <form action="{{ route('tools.reports.destroy',$item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <div class="hstack gap-2 justify-content-end">
                                                                            <button type="button" class="btn btn-info" data-bs-dismiss="modal">{{
                                                                                    trans('Dashboard/Tublar/tools.close')
                                                                                    }}</button>

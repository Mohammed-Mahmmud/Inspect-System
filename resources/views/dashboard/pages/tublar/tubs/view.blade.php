                        ...
                        <div class="page-title-tubsht">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">{{
                                        TranslationHelper::translate('tubs') }}</a></li>
                        ...
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                <div class="col-sm-auto">
                                    <div>
                                        <a class="btn btn-success add-btn" href="{{ route('tubs.reports.create',['type'=>$type]) }}">{{
                                                TranslationHelper::translate('new'.' '.$type) }}</a>
                                    </div>
                                </div>
                                <div class="col-sm">
...
{{--                                            @include('dashboard.pages.tublar.tubs.modal.search')--}}
                            ...
                            <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <th class="" data-sort="">{{TranslationHelper::translate('report_number') }}</th>
                                            <th class="" data-sort="">{{ TranslationHelper::translate('report_date') }}</th>
                                            <th class="" data-sort="">{{ TranslationHelper::translate('fin_date') }}</th>
                                            <th class="" data-sort="">{{ TranslationHelper::translate('user') }}</th>
                                            @if($type == 'thorough')
                                            <th class="" data-sort="">{{ TranslationHelper::translate('thorough_type') }}</th>
                                            @endif
                                            <th class="" data-sort="action">{{TranslationHelper::translate('acceptance') }}</th>
                                            <th class="" data-sort="action">{{ TranslationHelper::translate('action')}}</th>
                                        </tr>
                                    </thead>
                                                ...
                                                <div class="dropdown position-static">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li><a class="dropdown-item edit-item-btn"
                                                               target="_blank"
                                                               href="{{ route('tubs.edit', $item->id) }}"><i
                                                        ...
                                                        <li><a class="dropdown-item download-item-btn"
                                                               target="_blank"
                                                               href="{{ route('tubs.download',$item->id) }}"><i
                                                                    class="bx bx-download align-middle me-1"></i>
                                                                Download</a></li>
                                                    </ul>
                                                    <!-- Modal -->
                                                    <form action="{{ route('tubs.reports.destroy',$item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')

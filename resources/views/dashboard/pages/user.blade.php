                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div>
                                            <ul class="list-unstyled vstack gap-2">
                                                ...
                                                <li class="p-2 rounded">
                                                    <i
                                                        class="ri-checkbox-blank-circle-fill text-info align-bottom me-1"></i>
                                                ...
                                                <li class="p-2 rounded">
                                                    <i
                                                        class="ri-checkbox-blank-circle-fill text-danger align-bottom me-1"></i>
                        ...
                        <div class="card card-height-100">
                            ...
                            <div class="card-body px-0">
                                <div data-simplebar="" class="px-3" style="max-height: 360px;">
                                    <table class="table mb-0 table_id">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('dashboard') }}/assets/images/users/48/avatar-2.jpg"
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('dashboard') }}/assets/images/users/48/avatar-7.jpg"
                                                                alt="" class="avatar-sm rounded-circle p-1">
                                                        </div>
                                                        <div class="flex-grow-1">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('dashboard') }}/assets/images/users/48/avatar-4.jpg"
                                                                alt="" class="avatar-sm rounded-circle p-1">
                                                        </div>
                                                        <div class="flex-grow-1">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('dashboard') }}/assets/images/users/48/avatar-5.jpg"
                                                                alt="" class="avatar-sm rounded-circle p-1">
                                                        </div>
                                                        <div class="flex-grow-1">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('dashboard') }}/assets/images/users/48/avatar-6.jpg"
                                                                alt="" class="avatar-sm rounded-circle p-1">
                                                        </div>
                                                        <div class="flex-grow-1">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('dashboard') }}/assets/images/users/48/avatar-1.jpg"
                                                                alt="" class="avatar-sm rounded-circle p-1">
                                                        </div>
                                                        <div class="flex-grow-1">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-1">
                                                        <div class="flex-shrink-0">
                                                            <img src="{{ asset('dashboard') }}/assets/images/users/48/avatar-8.jpg"
                                                                alt="" class="avatar-sm rounded-circle p-1">
                                                        </div>
                                                        <div class="flex-grow-1">
                    ...
                    <div class="col-lg-8">
                        <div class="card" id="contactList">
                            ...
                            <div class="card-body">
                                <div class="table">
                                    <table
                                        class="table table-borderless table-centered align-middle table-nowrap mb-0 table_id">
                                        <thead class="text-muted table-dark">
                                            <tr>
                                                <th scope="col" class="sort cursor-pointer" data-sort="order_date">
                                                    Order Date</th>
                                                <th scope="col" class="sort cursor-pointer" data-sort="order_id">Order
                                                    ID</th>
                                                ...
                                                <th scope="col" class="sort cursor-pointer" data-sort="rating">Rating
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody class="list">
                                            <tr>
                                                ...
                                                <td class="shop">
                                                    <img src="{{ asset('dashboard') }}/assets/images/companies/img-7.png"
                                    ...
                                    <div class="noresult" style="display: none">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mb-0">We've searched more than 150+ transactions We did
                                                not find any transactions for you search.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="vstack gap-2">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{ asset('dashboard') }}/assets/images/products/32/img-1.png"
                                                            alt="" class="avatar-xs">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="p-2 border border-dashed">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{ asset('dashboard') }}/assets/images/products/32/img-2.png"
                                                            alt="" class="avatar-xs">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="p-2 border border-dashed">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{ asset('dashboard') }}/assets/images/products/32/img-3.png"
                                                            alt="" class="avatar-xs">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="p-2 border border-dashed">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{ asset('dashboard') }}/assets/images/products/32/img-4.png"
                                                            alt="" class="avatar-xs">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="p-2 border border-dashed">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{ asset('dashboard') }}/assets/images/products/32/img-5.png"
                                                            alt="" class="avatar-xs">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                        ...
                                        <div class="p-2 border border-dashed">
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="avatar-sm flex-shrink-0">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{ asset('dashboard') }}/assets/images/products/32/img-6.png"
                                                            alt="" class="avatar-xs">
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="progress animated-progress" role="progressbar"

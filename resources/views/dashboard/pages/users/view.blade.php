        ...
        <div class="page-content">
            <div class="container-fluid">
                <x-dashboard.layouts.breadcrumb title1="{{ trans('Dashboard/users.users') }}"
                                        title2="{{ trans('Dashboard/users.users') }}"
                                        title3="{{ trans('Dashboard/users.viewusers') }}"/>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sort"
                                                    data-sort="customer_name">{{ trans('Dashboard/users.name') }}</th>
                                                <th class="sort"
                                                    data-sort="full_name">{{ trans('Dashboard/users.full_name') }}</th>
                                                <th class="sort"
                                                    data-sort="email">{{ trans('Dashboard/users.email') }}</th>
                                                <th class="sort"
                                                    data-sort="date">{{ trans('Dashboard/users.joinDate') }}</th>
                                                <th class="sort"
                                                    data-sort="action">{{ trans('Dashboard/users.action') }}</th>
                                            </tr>
                                            </thead>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLongTitle">{{ trans('Dashboard/users.remove') }} {{ $item->name}}</h5>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header bg-light p-3">
                                        <h5 class="modal-title"
                                            id="exampleModalLabel2">{{ trans('Dashboard/users.edit').' '.$item->name }}</h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <input type="text" id="name" name="name" class="form-control"
                                                               placeholder="Enter user Name" value="{{ $item->name }}"
                                                               required="">
                                                    </div>
                                                    <div class="col-6">
                                                        <label for="full_name"
        ...
        <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-light p-3">
                        <h5 class="modal-title"
                            id="exampleModalLabel">{{ trans('Dashboard/users.create_new_user') }}</h5>

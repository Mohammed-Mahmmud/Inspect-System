...
<table class="info-table1">
    ...
    <tr>
        ...
        <td style=" width:25%;" class=" table1-content">
            <input type="checkbox" id="checkbox1" disabled @if(in_array('ac', $mpi->getDeCode($mpi->magnetizing_current)))
            checked @endif>
            <label for="checkbox1">Alternatind(AC)</label>
            &nbsp;&nbsp;

            <input type="checkbox" id="checkbox2" disabled @if(in_array('dc', $mpi->getDeCode($mpi->magnetizing_current)))
            checked @endif>
        ...
        <td class="table1-content" style=" width:30%;">
            <input type="checkbox" id="checkbox1" disabled @if(in_array('dry', $mpi->getDeCode($mpi->magnetic_particles)))
            checked @endif>
            <label for="checkbox1">Dry</label>
            &nbsp;
            <input type="checkbox" id="wet" disabled @if(in_array('wet', $mpi->getDeCode($mpi->magnetic_particles)))
            checked @endif>
            <label for="wet">Wet</label>
            &nbsp;
            <input type="checkbox" id="checkbox2" disabled @if(in_array('visibale', $mpi->getDeCode($mpi->magnetic_particles)))
            checked @endif>
            <label for="checkbox2">Visibale</label>
            &nbsp;
            <input type="checkbox" id="checkbox2" disabled @if(in_array('flourescent', $mpi->getDeCode($mpi->magnetic_particles)))
            checked @endif>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="width: 100px;">
                <input type="checkbox" id="checkbox1" disabled @if($mpi->getDeCode($mpi->equipment)['ac_yoke'])
                checked
                @endif
                >
                <label>AC Yoke</label>
            ...
            <td style="width: 100px;">
                <input type="checkbox" id="checkbox2" disabled @if($mpi->getDeCode($mpi->equipment)['dc_coil'])
                checked
                @endif>
                <label>DC Coil</label>
            </td>
            <td style="width: 100px;">
                <input type="checkbox" id="checkbox2" disabled @if($mpi->getDeCode($mpi->equipment)['permanent_magnet'])
                checked
                @endif>
            ...
            <td style="width: 100px;">
                <input type="checkbox" id="checkbox2" disabled @if($mpi->getDeCode($mpi->equipment)['uv_light'])
                checked
                @endif>
        ...
        <tr>
            <td style="width: 100px;">
                <label>No.</label>
                <input class="frameless" type="text" disabled value="{{ $mpi->getDeCode($mpi->equipment)['ac_yoke_no'] ?? '' }}">
            </td>
            <td style="width: 100px;">
                <label>No.</label>
                <input class="frameless" type="text" disabled value="{{ $mpi->getDeCode($mpi->equipment)['dc_coil_no'] ?? '' }}">
            </td>
            <td style="width: 100px;">
                <label>No.</label>
                <input class="frameless" type="text" disabled value="{{ $mpi->getDeCode($mpi->equipment)['permanent_magnet_no'] ?? '' }}">
            </td>
            <td style="width: 100px;">
                <label>No.</label>
                <input class="frameless" type="text" disabled value="{{ $mpi->getDeCode($mpi->equipment)['uv_light_no'] ?? '' }}">
            </td>
        ...
        <tr>
            ...
            <td class="left" colspan='1' style="width: 100px;">
                <label>No.</label>
                <input class="frameless" type="text" disabled value="{{ $mpi->getDeCode($mpi->equipment)['other_no'] ?? '' }}">
            </td>
        </tr>
        @endif
    </tbody>
...
<div class="custom_row">
    <div class="custom_column">
        <table class="info-table1">
            ...
            <tr>
                ...
                <td class="table1-content">
                    <input type="checkbox" id="checkbox1" disabled @if(isset($mpi->getDeCode($mpi->specification)['select']) && in_array('api', $mpi->getDeCode($mpi->specification)['select']))
                    checked
                    @endif>
                    ...
                    <input type="checkbox" id="checkbox1" disabled @if(isset($mpi->getDeCode($mpi->specification)['select']) && in_array('dsi', $mpi->getDeCode($mpi->specification)['select']))
                    checked
                    @endif>
                    <label>DS1</label>
                    &nbsp;

                    <input type="checkbox" id="checkbox2" disabled @if(isset($mpi->getDeCode($mpi->specification)['select']) && in_array('astm', $mpi->getDeCode($mpi->specification)['select']))
                    checked
                    @endif>
                    <label>ASTM</label>
                    &nbsp;

                    <input type="checkbox" id="checkbox2" disabled @if(isset($mpi->getDeCode($mpi->specification)['select']) && in_array('asme', $mpi->getDeCode($mpi->specification)['select']))
                    checked
                    @endif >
                    <label>ASME</label>
                    &nbsp;

                    <input type="checkbox" id="checkbox2" disabled @if(isset($mpi->getDeCode($mpi->specification)['select']) && in_array('aws', $mpi->getDeCode($mpi->specification)['select']))
                    checked
                    @endif >
                    <label>AWS</label>
                    &nbsp;
                    <input type="checkbox" id="checkbox2" disabled @if(isset($mpi->getDeCode($mpi->specification)['other']))
                    checked
                    @endif>
    ...
    <div class="col">
        <table class="info-table1">
            ...
            <tr>
                <td>
                    <input class="frameless center" type="text" style="width: 100%;" value="{{$mpi->getDeCode($mpi->surface_condition)[0] ?? ""}}">
                </td>
            </tr>
        </table>
    </div>

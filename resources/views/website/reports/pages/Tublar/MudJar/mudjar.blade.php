...
<table class="info-table1">
    <tbody>
        ...
        <tr>
            <td style="width: 10% ">{{ $body->serial_no ?? '' }} </td>
            <td style="width: 40% ">{{ $body->description ?? '' }}</td>
            <td style="width: 5% ">{{ $body->length ?? '' }} </td>
            <td style="width: 10% ">{{ $body->box_thread ?? '' }} </td>
            <td style="width: 5% "> {{ $body->box_od ?? '' }}</td>
            <td style="width: 5% ">{{ $body->box_cond ?? '' }}</td>
            @if($mudjar->type == 'mud')
            <td style="width: 10% ">{{ $body->body_thread_cond ?? '' }}</td>
            @endif
            <td style="width: 5% ">{{ $body->pin_conn ?? '' }} </td>
            <td style="width: 5% "> {{ $body->pin_id ?? '' }}</td>
            <td style="width: 5% ">{{ $body->pin_cond ?? '' }}</td>
        </tr>
        @endforeach
        <tr>
            <td><b>Summary</b></td>

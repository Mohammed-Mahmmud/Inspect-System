                                            ...
                                            <thead class="table-dark">
                                                <tr>
                                                    ...
                                                    <th data-sort="customer_name">
                                                        <?php echo e(trans('Dashboard/company.name')); ?></th>
                                                    
                                                    <th data-sort="customer_email">
                                                        <?php echo e(trans('Dashboard/company.email')); ?></th>
                                                    <th data-sort="customer_password">
                                                        <?php echo e(trans('Dashboard/company.password')); ?></th>
                                                    
                                                    <th data-sort="action">
                                                        <?php echo e(trans('Dashboard/company.action')); ?></th>
                                                </tr>
                                            </thead>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title"
                                                                                        ...
                                                                                        <?php echo e(trans('Dashboard/company.remove')); ?>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header bg-light p-3">
                                        <h5 class="modal-title" id="exampleModalLabel2">
                                            <?php echo e(trans('Dashboard/company.edit') . ' ' . $item->name); ?></h5>
                ...
                <div class="modal-content">
                    <div class="modal-header bg-light p-3">
                        <h5 class="modal-title" id="exampleModalLabel">
                            <?php echo e(trans('Dashboard/company.create_new_company')); ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                            id=""></button>
                    </div>
                    <form class="tablelist-form" action="" method="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="full_name" class="form-control"
                                            placeholder="<?php echo e(trans('Dashboard/company.placeholderFullName')); ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed-khater/Documents/projects/stc/inspection-system/resources/views/dashboard/pages/companies/view.blade.php ENDPATH**/ ?>
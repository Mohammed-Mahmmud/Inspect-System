...
<div class="modal-footer">
    <div class="hstack gap-2 justify-content-end">
        ...
        <button type="submit" class="btn btn-<?php echo e($color ? $color : 'success'); ?> "
            id="add-btn"><?php echo e($submit ? ucwords($submit) : TranslationHelper::translate('save')); ?></button>
    </div>
</div>
<?php /**PATH /home/mohamed-khater/Documents/projects/stc/inspection-system/resources/views/components/form/submit.blade.php ENDPATH**/ ?>
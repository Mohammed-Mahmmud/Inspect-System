                            ...
                            <div class="card mb-0 border-0 shadow-none mb-0">
                                <div class="card-body p-sm-5 m-lg-4">
                                    <div class="error-img text-center px-5">
                                        <img src="<?php echo e(asset('dashboard')); ?>/assets/images/auth/404.png" class="img-fluid" alt="404"
                                             style="height:350px">
                                    </div>
                                    <div class="mt-4 text-center pt-3">
                                        <div class="position-relative">
                                            <h1 class="fs-2xl error-subtitle text-uppercase mb-0 " ><span style="color: red;">404</span><br>Opps, page not found
                                            </h1>
                                        </div>
                                    </div>
                                </div><!-- end card body -->
...
<?php /**PATH /home/mohamed-khater/Documents/projects/stc/inspection-system/resources/views/errors/404.blade.php ENDPATH**/ ?>
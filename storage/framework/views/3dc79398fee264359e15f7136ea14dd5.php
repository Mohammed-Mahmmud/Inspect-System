...
<li class="nav-item">
    ...
    class="nav-link
   <?php if(Request::fullUrl() === (!empty($item->type) ? route($item->route, ['type' => $item->type]) : route($item->route))): ?>
   activeSidebar
   <?php endif; ?>" data-key="t-detached"><?php echo e(ucwords($item->name)); ?></a>
    <?php else: ?>
    <a class="nav-link" href="#<?php echo e($item->id); ?>"
         data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="<?php echo e($item->id); ?>">
         <?php if($item->icon): ?>
...
<script src="<?php echo e(asset('dashboard/layouts/components/sidebar/js/script.js')); ?>"></script><?php /**PATH /home/mohamed-khater/Documents/projects/inspection-system/resources/views/components/dashboard/layouts/sidebar-items.blade.php ENDPATH**/ ?>
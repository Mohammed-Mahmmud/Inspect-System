                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title mb-0"><?php echo e(TranslationHelper::translate(ucwords('new role'))); ?></h4>
                            </div><!-- end card header -->
                            <div class="card-body">
                                <div id="customerList">
                                    <div class="row g-4 mb-3">
                                        <div class="col-sm-auto">
                                            <a class="btn btn-success add-btn" href="<?php echo e(route('dashboard.roles.create')); ?>"
                                                ...
                                                data-bs-target="#showModal"><?php echo e(TranslationHelper::translate('Create New Role')); ?></a>
                                        </div>
                                        <div class="col-sm">
...
<?php $component->withAttributes(['value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($item->permissions
                                                                                                ->pluck('name', 'id')
                                                                                                ->toArray()),'label' => ''.e(TranslationHelper::translate('Choose Permissions:')).'','name' => 'permission','data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($permissions->pluck(
                                                                                                'name',
                                                                                                'id',
                                                                                            )),'span' => ''.e(TranslationHelper::translate('Choose Permissions:')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                            ...
                            <div class="modal-content">
                                <div class="modal-header bg-light p-3">
                                    <h5 class="modal-title" id="exampleModalLabel">
                                        <?php echo e(TranslationHelper::translate('Create New Role')); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(TranslationHelper::translate('Choose Permissions:')).'','name' => 'permission','data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($permissions->pluck('name', 'id')),'span' => ''.e(TranslationHelper::translate('Choose Permissions:')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal790df7f44302ddf124043596e8ccb3ef)): ?>
<?php $attributes = $__attributesOriginal790df7f44302ddf124043596e8ccb3ef; ?>

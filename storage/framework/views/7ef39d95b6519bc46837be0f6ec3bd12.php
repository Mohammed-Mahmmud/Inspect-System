`
<?php $__env->startSection('title',trans('Dashboard/admins.title')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title1' => ''.e(trans('Dashboard/admins.admins')).'','title2' => ''.e(trans('Dashboard/admins.admins')).'','route' => ''.e(route('admins.index')).'','title3' => ''.e(trans('Dashboard/admins.viewadmins')).'']); ?>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0"><?php echo e(trans('Dashboard/admins.addadmins')); ?></h4>
                        </div><!-- end card header -->
                                ...
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            ...
                                            <a class="btn btn-success add-btn" href="<?php echo e(route('admins.create')); ?>" data-bs-toggle="modal" data-bs-target="#showModal"><?php echo e(trans('Dashboard/admins.addAdmin')); ?></a>
...
<?php endif; ?>
                            ...
                            <table class="table align-middle mb-0">
                                  <thead class="table-dark">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="customer_name"><?php echo e(trans('Dashboard/admins.name')); ?></th>
                                                <th class="sort" data-sort="customer_name"><?php echo e(trans('Dashboard/admins.full_name')); ?></th>
                                                <th class="sort" data-sort="email"><?php echo e(trans('Dashboard/admins.email')); ?></th>
                                                <th class="sort" data-sort="date"><?php echo e(trans('Dashboard/admins.joinDate')); ?></th>
                                                <th class="sort" data-sort="action"><?php echo e(trans('Dashboard/admins.action')); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                <td class="customer_name"><?php echo e($item->full_name); ?></td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <!-- Modal -->
                                                        <form action="<?php echo e(route('admins.destroy', $item->id)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalLongTitle"><?php echo e(trans('Dashboard/admins.remove')); ?> <?php echo e($item->name); ?></h5>
                                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <?php echo e(trans('Dashboard/admins.delete_message').'  '.$item->name); ?>

                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <div class="hstack gap-2 justify-content-end">
                                                                                <button type="button" class="btn btn-info" data-bs-dismiss="modal"><?php echo e(trans('Dashboard/admins.close')); ?></button>

                                                                                <button type="submit" class="btn btn-danger" id="add-btn"><?php echo e(trans('Dashboard/admins.delete')); ?></button>
                                                        </form>
                ...
                <form class="tablelist-form" action="<?php echo e(route('admins.update',$item)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header bg-light p-3">
                                    <h5 class="modal-title" id="exampleModalLabel2"><?php echo e(trans('Dashboard/admins.edit').' '.$item->name); ?></h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                                </div>
                                <form class="tablelist-form" action="" method="">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-6">
                                                    <label for="name" class="form-label"><?php echo e(trans('Dashboard/admins.name')); ?></label>
                                                    <input type="text" id="name" name="name" class="form-control" placeholder="Enter admin Name" value="<?php echo e($item->name); ?>" required="">
                                                </div>
                                                <div class="col-6">
                                                    <label for = "full_name" class="form-label"><?php echo e(trans('Dashboard/admins.full_name')); ?></label>
                                                    <input type="text" id="full_name" name="full_name" class="form-control" placeholder="Enter admin Name" value="<?php echo e($item->full_name); ?>" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-6">
                                                    <label for="email" class="form-label"><?php echo e(trans('Dashboard/admins.email')); ?></label>
                                                    <input type="text" id="email" name="email" class="form-control" placeholder=" Enter admin email" value="<?php echo e($item->email); ?>" required="">
                                                </div>

                                                <div class="col-6">
                                                    <label for="password" class="form-label"><?php echo e(trans('Dashboard/admins.updatePassword')); ?></label>
                                    ...
                                    <div class="modal-footer">
                                        <div class="hstack gap-2 justify-content-end">
                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><?php echo e(trans('Dashboard/admins.close')); ?></button>

                                            <button type="submit" class="btn btn-info" id="add-btn"><?php echo e(trans('Dashboard/admins.update_admin')); ?></button>
                                </form>
                                <!-- <button type="button" class="btn btn-success" id="edit-btn">Update</button> -->
                            </div>
                        </div>
...
<form class="tablelist-form" action="<?php echo e(route('admins.store')); ?>" method="POST">
    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-light p-3">
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo e(trans('Dashboard/admins.create_new_Admin')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
                </div>
                <form class="tablelist-form" action="" method="">
                    <div class="modal-body">
                        <div class="container mb-3">
                            <div class="row">
                                <div class="col-6">
                                    <label for="name" class="form-label"><?php echo e(trans('Dashboard/admins.name')); ?></label>
                                    <input type="text" id="name" name="name" class="form-control" placeholder="<?php echo e(trans('Dashboard/admins.name')); ?>" required>
                                </div>
                                <div class="col-6">
                                    <label for="full_name" class="form-label"><?php echo e(trans('Dashboard/admins.full_name')); ?></label>
                                    <input type="text" id="full_name" name="full_name" class="form-control" placeholder="<?php echo e(trans('Dashboard/admins.full_name')); ?>" required>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                    ...
                    <div class="modal-footer">
                        <div class="hstack gap-2 justify-content-end">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><?php echo e(trans('Dashboard/admins.close')); ?></button>
                            <button type="submit" class="btn btn-success" id="add-btn"><?php echo e(trans("Dashboard/admins.add")); ?></button>
                </div>
        </div>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                    <button type="button" class="btn w-sm btn-info" data-bs-dismiss="modal"><?php echo e(trans('Dashboard/admins.close')); ?></button>
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed-khater/Documents/projects/inspection-system/resources/views/dashboard/pages/admins/view.blade.php ENDPATH**/ ?>
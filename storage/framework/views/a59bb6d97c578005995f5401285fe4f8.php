                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <th class=""
                                                    data-sort=""><?php echo e(trans('Dashboard/Lifting/examination.report_number')); ?></th>
                                                <th class=""
                                                    data-sort=""><?php echo e(trans('Dashboard/Lifting/examination.exam_date')); ?></th>
                                                <th class=""
                                                    data-sort=""><?php echo e(trans('Dashboard/Lifting/examination.user')); ?></th>
                                                
                                                <?php if($type == 'thorough'): ?>
                                                    <th class=""
                                                        data-sort=""><?php echo e(trans('Dashboard/Lifting/examination.thorough_type')); ?></th>
                                                <?php endif; ?>
                                                <th class=""
                                                    data-sort="action"><?php echo e(trans('Dashboard/Lifting/examination.acceptance')); ?></th>
                                                <th class=""
                                                    data-sort="action"><?php echo e(trans('Dashboard/Lifting/examination.action')); ?></th>
                                            </tr>
                                            </thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="dropdown position-static">
                                                            ...
                                                            <!-- Modal -->
                                                            <form action="<?php echo e(route('examination.reports.destroy',$item->id)); ?>"
                                                                  method="POST">
                                                                <?php echo csrf_field(); ?>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLongTitle"><?php echo e(trans('Dashboard/Lifting/examination.remove')); ?>

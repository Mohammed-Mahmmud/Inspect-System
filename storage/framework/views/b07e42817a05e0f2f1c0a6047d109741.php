 ...
 <div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <a href="<?php echo e(route('mainDashboard.index')); ?>" class="logo logo-light">
            <span class="logo-sm">
                <img src="<?php echo e(asset('dashboard/assets/images/stclogo-light.png')); ?>" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(asset('dashboard/assets/images/stclogo-light.png')); ?>" alt="" height="100">
            </span>
        </a>
...
<?php /**PATH /home/mohamed-khater/Documents/projects/stc/inspection-system/resources/views/components/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
        <section class="auth-page-wrapper py-5 position-relative d-flex align-items-center justify-content-center min-vh-100"style="background-image: url('<?php echo e(asset('dashboard/images/background/login.jpg')); ?>'); background-size: cover; background-position: center;">
            <div class="container">
                                    ...
                                    <div class="card mb-0 border-0 shadow-none mb-0">
                                        <div class="card-body p-sm-100 m-lg-1">
                                            <div class="text-center mt-1">
                                                <img src="<?php echo e(asset('dashboard/images/background/stc_logo.png')); ?>" alt="Custom Image" class="rounded mb-3" style="width: 400px; height: 200px;">
                                                <h5 class="fs-3xl"><?php echo e(trans('Dashboard/login_trans.Welcome Back')); ?></h5>
                                                <p class="text-muted"><?php echo e(trans('Dashboard/login_trans.lss')); ?></p>
                                            </div>
                                            <div class="p-1 mt-1">
                                                ...
                                                <form method="POST" action="<?php echo e(route('login')); ?>">
                                                    ...
                                                    <div class="mb-3" >
                                                        <?php endif; ?>
                                                        <label for="email" class="form-label"><?php echo e(trans('Dashboard/login_trans.Email')); ?> <span class="text-danger">*</span></label>
...
<?php endif; ?>
                                                    ...
                                                    <div class="mb-3" >
                                                        <?php endif; ?>
                                                        <div class="float-end">
                                                            <a href="<?php echo e(route('password.request')); ?>" class="text-muted"><?php echo e(trans('Dashboard/login_trans.Forgot password?')); ?></a>
                                                        </div>
                                                        <label class="form-label" for="password-input"><?php echo e(trans('Dashboard/login_trans.Password')); ?> <span class="text-danger">*</span></label>
...
<?php endif; ?>
                                                    ...
                                                    <div class="form-check" >
                                                        ...
                                                        <label class="form-check-label" for="auth-remember-check"><?php echo e(trans('Dashboard/login_trans.Remember me')); ?> </label>
                                                    </div>
                                                    <br>
                                                  
                                                    
                                                        <button class="btn btn-primary w-100"  type="submit"><?php echo e(trans('Dashboard/login_trans.login')); ?></button>
                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layouts.auth.auth-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mohamed-khater/Documents/projects/inspection-system/resources/views/dashboard/auth/signin.blade.php ENDPATH**/ ?>
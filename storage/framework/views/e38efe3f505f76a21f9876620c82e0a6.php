...
<?php $__env->startSection('content'); ?>
    <section
        class="auth-page-wrapper py-5 position-relative d-flex align-items-center justify-content-center min-vh-100"style="background-image: url('<?php echo e(asset('dashboard/images/background/login.jpg')); ?>'); background-size: cover; background-position: center;">
        <div class="container">
                                    ...
                                    <div class="card-body p-sm-100 m-lg-1">
                                        <div class="text-center mt-1">
                                            <a href="" class="logo logo-light">
                                                <span class="logo-sm">
                                                    <img src="<?php echo e(asset('dashboard/images/background/stc_logo.png')); ?>"
                                                        alt="" height="50px" width='100px'>
                                                </span>
                                                <span class="logo-lg">
                                                    <img src="<?php echo e(asset('dashboard/images/background/stc_logo.png')); ?>"
                                                        alt="" height="200ox" width='300px'>
                                                </span>
                                            </a>
...
<?php endif; ?>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label"
                                            for="auth-remember-check"><?php echo e(trans('Dashboard/login_trans.Remember me')); ?>
